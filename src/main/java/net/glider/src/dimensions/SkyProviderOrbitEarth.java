...
public class SkyProviderOrbitEarth extends IRenderHandler {
	...
	public SkyProviderOrbitEarth(ResourceLocation planet, boolean renderMoon, boolean renderSun)
	{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		if (this.renderSun)
		{
			...
			var12 = 28.0F;
			this.minecraft.renderEngine.bindTexture(SkyProviderOrbitEarth.sunTexture);
			var23.startDrawingQuads();
		...
		if (this.renderMoon)
		{
			...
			GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
			var12 = 40.0F;
			this.minecraft.renderEngine.bindTexture(SkyProviderOrbitEarth.moonTexture);

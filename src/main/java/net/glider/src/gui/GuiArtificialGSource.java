...
public class GuiArtificialGSource extends GuiContainerGC {
	private static final ResourceLocation texture = new ResourceLocation(GliderModInfo.ModTestures, "textures/gui/ArtificialGsource.png");
	...
	public void initGui()
	{
		...
		electricityDesc.add(EnumColor.YELLOW + GCCoreUtil.translate("gui.energyStorage.desc.1") + ((int) Math.floor(this.Gsource.getEnergyStoredGC()) + " / " + (int) Math.floor(this.Gsource.getMaxEnergyStoredGC())));

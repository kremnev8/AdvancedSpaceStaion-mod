...
public class ItemUtil {
	...
	public static boolean haveListItem(List<ItemStack> found, ItemStack is)
	{
		for (int i = 0; i < found.size(); i++)
		{
			...
			if (is != null && curr != null && curr.getItem() == is.getItem() && (!is.getHasSubtypes() || curr.getItemDamage() == is.getItemDamage()) && curr.stackSize >= is.stackSize)
			{
				return true;
			}
		}
	...
	public static boolean AreItemStackEqual(ItemStack is1, ItemStack is2, boolean ignoreStackSize)
	{
		...
		if (is1 != null && is2 != null && (ArrContain1SameInt(OreDictionary.getOreIDs(is1), OreDictionary.getOreIDs(is2)) || (is1.getItem() == is2.getItem()) && (!is1.getItem().getHasSubtypes() || is2.getItemDamage() == is1.getItemDamage())) && (is1.stackSize >= is2.stackSize || ignoreStackSize))

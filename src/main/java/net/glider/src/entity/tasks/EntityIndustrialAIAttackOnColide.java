package net.glider.src.entity.tasks;
...
public class EntityIndustrialAIAttackOnColide extends EntityAIBase
{
    World worldObj;
    ...
    public EntityIndustrialAIAttackOnColide(EntityCreature p_i1635_1_, Class p_i1635_2_, double p_i1635_3_, boolean p_i1635_5_)
    {
        this(p_i1635_1_, p_i1635_3_, p_i1635_5_);
        this.classTarget = p_i1635_2_;
    }

    public EntityIndustrialAIAttackOnColide(EntityCreature p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_)
    {
    ...
    public void updateTask()
    {
        ...
        double d1 = (double)(this.attacker.width * this.attacker.width + entitylivingbase.width);
        --this.field_75445_i;
        ...
        if ((this.longMemory || this.attacker.getEntitySenses().canSee(entitylivingbase)) && this.field_75445_i <= 0 && (this.field_151497_i == 0.0D && this.field_151495_j == 0.0D && this.field_151496_k == 0.0D || entitylivingbase.getDistanceSq(this.field_151497_i, this.field_151495_j, this.field_151496_k) >= 1.0D || this.attacker.getRNG().nextFloat() < 0.05F))
        {
            ...
            if (this.attacker.getNavigator().getPath() != null)
            {
                ...
                if (finalPathPoint != null && entitylivingbase.getDistanceSq(finalPathPoint.xCoord, finalPathPoint.yCoord, finalPathPoint.zCoord) == 0)
                {

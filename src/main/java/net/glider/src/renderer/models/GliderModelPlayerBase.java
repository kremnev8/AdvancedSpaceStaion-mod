...
public class GliderModelPlayerBase extends ModelPlayerBase {
	...
	public void afterSetRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
	{
		...
		if (player.getCurrentArmor(2) != null && (Minecraft.getMinecraft().gameSettings.thirdPersonView != 0 || Minecraft.getMinecraft().currentScreen != null
				|| !entity.getCommandSenderName().equals(Minecraft.getMinecraft().thePlayer.getCommandSenderName())))
		{

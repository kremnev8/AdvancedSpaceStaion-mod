...
import net.glider.src.entity.tasks.EntityAIIndustrialCreeperSwell;
import net.glider.src.entity.tasks.EntityIndustrialAIAttackOnColide;
...
public class EntityIndustrialCreeper extends EntityMob {
	...
	public EntityIndustrialCreeper(World p_i1733_1_)
	{
		super(p_i1733_1_);
		this.tasks.addTask(1, new EntityAISwimming(this));
		this.tasks.addTask(2, new EntityAIIndustrialCreeperSwell(this));
		this.tasks.addTask(3, new EntityAIAvoidEntity(this, EntityOcelot.class, 6.0F, 1.0D, 1.2D));
		this.tasks.addTask(4, new EntityIndustrialAIAttackOnColide(this, 1.0D, false));
		this.tasks.addTask(5, new EntityAIWander(this, 0.8D));
		this.tasks.addTask(6, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
		this.tasks.addTask(6, new EntityAILookIdle(this));
		this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, false));
		this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityAIMarker.class, 0, true));
	}

...
import micdoodle8.mods.galacticraft.core.client.fx.EntityFXOilDrip;
...
public class EffectHandler {
	public static void spawnParticle(String particleID, Vector3 position, Vector3 motion, Object... otherInfo)
	{
		...
		if (mc != null && mc.renderViewEntity != null && mc.effectRenderer != null)
		{
			...
			} else if (particleID.equals("whiteShortSmokeIdle"))
			{
				particle = new EntityFXSmoke(mc.theWorld, position, motion, 1.0F, true, 5);
			...
			{
				particle = new EntityFXLaunchSmallFlame(mc.theWorld, position, motion, true, (EntityLivingBase) otherInfo[0]);

...
import gloomyfolken.hooklib.asm.VariableIdHelper;

@Mod(modid = GliderModInfo.MOD_ID, name = GliderModInfo.MOD_NAME, version = GliderModInfo.Version, acceptedMinecraftVersions = "1.7.10", dependencies = "required-after:OpenComputers@[1.5,);"
		+ "required-after:GalacticraftCore@[3.0,);" + "required-after:GalacticraftMars@[3.0,);" + "required-after:RenderPlayerAPI;")
...
public class GliderCore {
	...
	public void init(FMLInitializationEvent event)
	{
		...
		satelliteAdvancedSpaceStation = (Satellite) new Satellite("advSpaceStation.mars").setParentBody(MarsModule.planetMars).setRelativeSize(0.2667F)

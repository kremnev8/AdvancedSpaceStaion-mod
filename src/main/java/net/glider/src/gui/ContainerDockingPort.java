...
public class ContainerDockingPort extends Container {
	...
	{
		parachestInventory.closeInventory();
		...
		this.addSlotToContainer(new SlotItemLocked(par2IInventory, par2IInventory.getSizeInventory() - 3, 125 + 0 * 18, (this.numRows == 0 ? 22 : 24) + this.numRows * 18, (List<ItemStack>) list1.clone()));
		list1.clear();
		list1.add(new ItemStack(GCItems.rocketTier1));
		list1.add(new ItemStack(MarsItems.spaceship));
		list1.add(new ItemStack(AsteroidsItems.tier3Rocket));
		this.addSlotToContainer(new SlotItemLocked(par2IInventory, par2IInventory.getSizeInventory() - 2, 125 + 1 * 18, (this.numRows == 0 ? 22 : 24) + this.numRows * 18, (List<ItemStack>) list1.clone(), (TileEntityDockingPort) parachestInventory));
		...
		parachestInventory.openInventory();
	}
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
	{
		...
		if (slot != null && slot.getHasStack())
		{
			...
			{
				if (itemstack1.getItem() == GCItems.rocketTier1 || itemstack1.getItem() == MarsItems.spaceship || itemstack1.getItem() == AsteroidsItems.tier3Rocket)
				{

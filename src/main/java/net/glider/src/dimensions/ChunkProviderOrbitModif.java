...
public class ChunkProviderOrbitModif extends ChunkProviderGenerate {
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
		...
		if (k == 0 && l == 0)
		{
			BuildHandler.HandleBuild(worldObj, ForgeDirection.UNKNOWN, strStart.getUnlocalizedName(), k, 64, l, 0, null);
		}

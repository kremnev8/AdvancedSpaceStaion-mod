...
public class SkyProviderOrbitModif extends IRenderHandler {
	...
	public SkyProviderOrbitModif(ResourceLocation planet, boolean renderMoon, boolean renderSun)
	{
		this.planetToRender = planet;
		this.renderMoon = false;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		if (this.renderSun)
		{
			...
			var12 = 28.0F;
			this.minecraft.renderEngine.bindTexture(SkyProviderOrbitModif.sunTexture);
			var23.startDrawingQuads();
		...
		if (this.renderMoon)
		{
			...
			GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
			var12 = 40.0F;
			this.minecraft.renderEngine.bindTexture(SkyProviderOrbitModif.moonTexture);
